...
export default function FeatureGrid({ onExploreFeature }) {
  return (
    <section className="py-12 md:py-20 bg-white dark:bg-[#0A0C0E] transition-colors duration-300" id="features">
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5 space-y-6 text-left">
            <span className="text-xs font-bold text-slate-400 dark:text-slate-500 font-mono block uppercase">:: TARGET OBJECTIVES</span>
            
            <h2 className="text-4xl sm:text-6xl font-extrabold text-[#111111] dark:text-[#F3F4F6] leading-tight">
              Customized Reviews <span className="font-serif italic font-normal text-slate-700 dark:text-slate-300">for You</span>
            </h2>
            ...
            {/* Floating text badge */}
            <div className="floating-card p-4 border border-[#E5E5EA] dark:border-[#262C36] bg-[#F5F5F7]/50 dark:bg-[#181C22] rounded-2xl flex items-center space-x-3 w-80">
          ...
          {/* Right Column (PC Mockup displaying plan details) */}
              ...
              <div className="pc-screen-content grid grid-cols-12 h-full bg-[#F5F5F7] dark:bg-[#121519]">
                ...
                <div className="col-span-12 p-5 space-y-4">
                  <div className="border-b border-[#E5E5EA] dark:border-[#262C36] pb-2 text-left">
                    <h3 className="text-sm font-bold text-slate-800 dark:text-slate-200 font-mono">Code Review Plan Configuration</h3>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-3 font-mono text-xs text-left">
                    ...
                    {/* Parameter 1 */}
                    <div className="bg-white dark:bg-[#181C22] p-3 rounded-xl border border-[#E5E5EA] dark:border-[#262C36] flex items-center justify-between col-span-2">
                      <div className="flex items-center space-x-2">
                        <FileCode className="w-4 h-4 text-slate-500 dark:text-slate-400" />
                        <div>
                          <span className="font-bold block text-slate-800 dark:text-slate-200">AST Parsed, No Errors</span>
                    ...
                    {/* Parameter 2 */}
                    <div className="bg-white dark:bg-[#181C22] p-3 rounded-xl border border-[#E5E5EA] dark:border-[#262C36] flex items-center space-x-2">
                      <Flame className="w-4 h-4 text-[#FF5500]" />
                      <div>
                        <span className="font-bold block text-slate-800 dark:text-slate-200">0.98 Cumulative</span>
                    ...
                    <div className="bg-white dark:bg-[#181C22] p-3 rounded-xl border border-[#E5E5EA] dark:border-[#262C36] flex items-center space-x-2">
                      ...
                      <div>
                        <span className="font-bold block text-slate-800 dark:text-slate-200">SQLi & Logic Checks</span>
                    ...
                    <div className="bg-white dark:bg-[#181C22] p-3 rounded-xl border border-[#E5E5EA] dark:border-[#262C36] flex items-center space-x-2">
                      ...
                      <div>
                        <span className="font-bold block text-slate-800 dark:text-slate-200">Standard Ruleset</span>
                    ...
                    <div className="bg-white dark:bg-[#181C22] p-3 rounded-xl border border-[#E5E5EA] dark:border-[#262C36] flex items-center justify-between col-span-2">
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-[10px] text-slate-500 dark:text-slate-400">Agent Alignment Progress</span>
                      </div>
