...
export default function InstructionsSection({ onNavigate }) {
  const steps = [
    ...
    },
    {
      ...
      badgeColor: "text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-950/40 border-blue-200 dark:border-blue-900/50",
    ...
    {
      icon: <Play className="w-5 h-5 text-emerald-600 dark:text-emerald-400" />,
      ...
      badgeColor: "text-emerald-600 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-950/40 border-emerald-200 dark:border-emerald-900/50",
    ...
    },
    {
      ...
      badgeColor: "text-purple-600 dark:text-purple-400 bg-purple-50 dark:bg-purple-950/40 border-purple-200 dark:border-purple-900/50",
  ...
  return (
    <section className="py-16 md:py-20 bg-[#F5F5F7] dark:bg-[#0A0C0E] border-t border-b border-[#E5E5EA] dark:border-[#262C36] transition-colors duration-300">
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
        
        {/* Section Header */}
        <div className="text-center max-w-xl mx-auto space-y-4 mb-14">
          <span className="text-xs font-bold text-[#FF5500] uppercase tracking-wider font-mono px-3.5 py-1 bg-white dark:bg-[#181C22] border border-[#E5E5EA] dark:border-[#262C36] rounded-full inline-block shadow-sm">
            :: DEVELOPER WORKFLOW
          </span>
