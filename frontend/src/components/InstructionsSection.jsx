...
export default function InstructionsSection({ onNavigate }) {
  ...
  return (
    <section className="py-16 md:py-20 bg-[#F5F5F7] border-t border-b border-[#E5E5EA]">
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
        
        {/* Section Header */}
        <div className="text-center max-w-xl mx-auto space-y-4 mb-14">
          <span className="text-xs font-bold text-[#FF5500] uppercase tracking-wider font-mono px-3.5 py-1 bg-white border border-[#E5E5EA] rounded-full inline-block shadow-sm">
            :: DEVELOPER WORKFLOW
          </span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {steps.map((step, idx) => (
            <div
              key={idx}
              className="relative overflow-hidden rounded-2xl p-6 border border-[#E5E5EA] bg-white shadow-sm hover:shadow-lg hover:border-[#FF5500]/50 hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between space-y-6 text-left group"
            >
              ...
              <div className="relative z-10 space-y-4">
                ...
                <h3 className="text-base font-bold text-[#111111] font-mono group-hover:text-[#FF5500] transition-colors">
                  {step.title}
                </h3>
              ...
              {/* Bottom Footer Tag */}
              <div className="relative z-10 pt-3 border-t border-[#E5E5EA]/80 flex items-center justify-between text-[10px] text-slate-400 font-mono">
